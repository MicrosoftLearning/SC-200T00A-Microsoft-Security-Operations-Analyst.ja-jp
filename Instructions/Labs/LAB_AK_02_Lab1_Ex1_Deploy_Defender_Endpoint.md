...
1. Edge ブラウザーで、Defender XDR ポータル (https://security.microsoft.com)) に移動します。
...
1. **Defender XDR** ポータルのナビゲーション メニューで、左側の **[設定]** を選択します。
...
1. Microsoft Defender XDR ポータルで、左側のメニュー バーから **[設定]** を選択し、**[エンドポイント]** を選びます。 
