...
1. 引き続き Microsoft Sentinel "コンテンツ ハブ" で操作する必要があります。**
...
1. **[Azure アクティビティ]** ソリューションの詳細ページで、**[Azure アクティビティ]** データ コネクタのチェックボックスをオンにし、**[コネクタ ページを開く]** を選択します。

1. 状態が [接続済み] と表示されていることに注意してください。**
...
1. ページの上部にある **[詳細オプション]** タブを選択して、*[UEBA の構成]* の設定を確認します。 この設定は、"Azure アクティビティ" に対して有効になっていることに注意してください。**

1. ブラウザーの "階層リンク" をたどって "コンテンツ ハブ" に戻り、終了します。****
