...
1. 表示される可能性のある Teams ポップアップをすべて閉じます。
    ...
    >**注:**  **[新しい Teams]** の使用が求められたら、承認し、演習を続行します。
...
1. プレイブックが表示されない場合は、コマンド バーの **[最新の情報に更新]** を選んでください。 前の手順で作成したプレイブックが表示されるはずです。
...
1. 次に、"*2 番目*" のブロック、**[メッセージの投稿 (V3)]** を選択します。

1. [パラメーター] タブで下にスクロールして **[接続の変更]** リンクを選択し、**[新規追加]** を選択し、**[サインイン]** を選択します。 情報を求めるメッセージが表示されたら、Azure 管理者の資格情報を選択します。 [パラメーター] タブに "管理者ユーザー名に接続済み" と表示されます。

1. *[チーム]* フィールドの最後で、**[X]** を選択して内容をクリアします。 フィールドは、Microsoft Teams から利用可能な Teams の一覧を含むドロップダウンに変更されます。 **[SOC]** を選択します。
