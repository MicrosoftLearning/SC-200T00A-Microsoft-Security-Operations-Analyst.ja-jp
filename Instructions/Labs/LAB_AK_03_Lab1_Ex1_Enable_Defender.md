...
1. 前の手順で作成した Log Analytics ワークスペース *uniquenameDefender* を選択して、使用可能なオプションと価格を確認します。 **[すべての Microsoft Defender for Cloud プランの有効化]** を選択し、 **[保存]** を選択します。 "ワークスペース uniquenameDefender の Azure Defender プランが正常に保存されました" という 通知が表示されるまで待ちます。
...
1. 管理者として WINServer仮想マシンにログインします。パスワードは **Passw0rd!** です (必要な場合)。  
