...
1. *MOC Subscription-XXXXXXXXXXX* の *[状態]* が *[接続済み]* で、*[双方向の同期]* が **[有効]** になっている必要があります。

    >**注:**  "双方向同期が有効になっている" ことを確認するには、この手順を再試行することが必要な場合があります。** 手順を実行し直した後、*[双方向の同期]* ドロップダウンを **[有効]** に設定してみてください。
