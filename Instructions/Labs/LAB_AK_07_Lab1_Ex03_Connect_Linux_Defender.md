...
1. [データ収集ルールの作成] ページの [基本] タブで、[ルール名] に「**AZLINxxxxxxxxDCR**」と入力してから、**[次へ: リソース]** を選択します。****
...
1. データ収集ルールによって Azure Monitor エージェント (AMA) がインストールされます。AMA Forwarder をインストールするための *AMA Forwarder* インストール コマンドは LIN2 マシン上に事前デプロイされています。
