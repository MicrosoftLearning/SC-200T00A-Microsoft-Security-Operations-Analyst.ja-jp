...
1. 次に、**学生 ID**、または割り当てられたユーザー名を一覧から選択します。 最初の 1 つのはずです。
...
>**注:** ラボ ホスティング プロバイダーは、Cloud Shell を有効にすることで規則をトリガーできるようにするための別の手順を提供する場合があります。 その場合は、以下の手順ではなく、これらの手順に従ってください。
