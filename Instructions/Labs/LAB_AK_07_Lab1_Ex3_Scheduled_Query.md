...
1. *[割り当ての追加]* ページの *[メンバーシップ]* タブで、 *[ロールの選択]* の下にある **[ユーザー管理者]** を選択します。

1. **[追加]** を選択します。

1. **注:**  場合によっては、 **[更新]** ボタンをクリックして、新しいロールの割り当てを表示する必要があります。 
...
1. **注:**  トリガーされたアラートの処理には 5 分以上かかる場合があります。

1. 次の演習を続けて、後でこのポイントに戻ることができます。 

    >[インシデント] ページを自動更新するには、**[インシデントの自動更新]** トグルをオンにします。 新しく作成したインシデントが表示されます。
