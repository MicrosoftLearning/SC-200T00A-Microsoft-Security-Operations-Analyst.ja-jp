...
# ラーニング パス 1 - ラボ 1 - 演習 1 - Microsoft 365 Defender の確認
...
1. 表示されている場合は、Microsoft 365 Defender クイック ツアーポップアップ ウィンドウを閉じます。 **ヒント:** このラボの後半では、Defender ワークスペースがプロビジョニングされるまで待つ必要があります。この時間を使ってガイド付きツアーを移動して、Microsoft 365 Defender の詳細を確認できます。
...
1. **[Microsoft 365 Defender]** ポータルのナビゲーション メニューで、左側の **[ホーム]** を選択します。
